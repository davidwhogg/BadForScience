...
\begin{abstract}
  ...
  Here we identify locations for ML in the natural sciences where the ontology and epistemology (and computational performance) are valuable.
  We also show that the introduction of ML introduces strong, unwanted statistical biases.
  ...
  On the other hand, there are also places where the introduction of ML can in fact make a project more scientifically conservative; when a flexible machine-learning model is used to represent the effects of nuisances, such as foregrounds, backgrounds, or instrument calibration parameters, the model capacity and loose philosophy can sometimes make the results more trustworthy.
