...
It is worthy of noting here that a successful theory is usually a combination of a simple theory of the latents, and a less simple observation model, which explains how the latents appear in the data space.

Differences aside, there is an argument to make that maybe the natural sciences could be better off if they moved at least slightly closer to the ML points of view on ontology and epistemology.
...
We are not recommending this, but noting that a robust theory of physics might be more positively oriented towards the data than standard practice.
...
Engineering point: Science requires execution of projects. Execution requires engineering. ML is often great for helping with that engineering.

\section{When is machine learning bad for natural science?}

Multiplication of priors argument. Confirmation bias argument.

\section{When is machine learning good for natural science?}
